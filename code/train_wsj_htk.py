...
parser.add_argument('--use_deltas_accs', dest='use_deltas_accs', type=bool,
                     default=True, help='Use deltas and accelerations')
...
parser.add_argument('--normalize', dest='normalize',  action='store', 
                     type=bool, default=True, help='Whether to normalize data')
parser.add_argument('--speaker_cmn', dest='speaker_cmn',  action='store_true', 
                     default=False, help='Whether to normalize data')
parser.add_argument('--speaker_cmvn', dest='speaker_cmvn',  action='store_true', 
                     default=False, help='Whether to normalize data')
...
for i in range(arguments.max_epochs):
    nn_train.train_one_epoch(data_src)
