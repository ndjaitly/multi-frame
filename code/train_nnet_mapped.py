...
parser.add_argument('--max_epochs', type=int, default=-1, 
         help='Override the max epochs param with this one')
...
parser.add_argument('map_file', type=str, help='file with mapping of labels')
...
shutil.copy2(arguments.map_file,
             os.path.join(arguments.output_fldr, "map_file.txt"))
...
label_map = genfromtxt(arguments.map_file)
data_src.set_label_map(label_map)

validation_src = htkdb_cm.htkdb_cm(arguments.validation_db_name,
                        arguments.db_path,
                        run_params.data_params.num_frames_per_pt,
                        run_params.data_params.use_delta)
validation_src.set_label_map(label_map)
...
err_tol = 0
eps_ratio=1.0
num_epochs = run_params.max_epochs
if arguments.max_epochs != -1: num_epochs = arguments.max_epochs
