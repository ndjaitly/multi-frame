...
parser.add_argument('model_fldr', help='my neural network folder')
parser.add_argument('output_file', help='output confusion matrix file')
...
confusion_matrix = compute_confusion_matrix(nn_train, data_src)
savetxt(arguments.output_file, confusion_matrix, fmt='%.1f')
